...
def list_speech_models() -> dict:
    return {"models": ["small"]}
# Default. Put the name of model from list - example ["small"]
# list of avainable models: tiny.en, tiny, base.en, base, small.en, small, medium.en, medium, large-v1, large-v2, large-v3, large, distil-large-v2, distil-medium.en, distil-small.en, distil-large-v3
